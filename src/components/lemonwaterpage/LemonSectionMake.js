...
const LemonSectionMake = ({ offsetY }) => {
    ...
    useEffect(() => {
        if(lemonselectionmake.current.offsetTop <= offsetY+400){
            setOffsetTop((offsetY-lemonselectionmake.current.offsetTop+400)*0.5);
        }
    },[offsetY]);
            ...
            <div className="lemon-selection-make-first">
                <div className="text-side">
                    <div>
                        ...
                        <p >
                            <b>Squeeze lemon juice into a glass.</b> Both hand held lemon reamer and glass lemon juicer reamer work well. It’s a matter of personal preference. The only difference – glass one catches the seeds. 
                        </p>
                        <p>
                            <b>Add warm water.</b> To make water warm, I mix boiling water with cold filtered water. Another option is to turn off kettle before water reaches boiling (you just have to wait by the kettle).
                        </p>
                        <p>
            ...
            <div className="lemon-selection-make-secound">
                <div className="text-side">
                    <div>
                        ...
                        <ul>
                            <li>Dilute lemon juice in 8 oz of water: I would do 1/2 cup + 3 tbsp boiling water + rest cold water.</li>
                            <li>Straw: Drink lemon water with a straw.</li>
                            <li>Rinsing: Rinse your mouth right after drinking lemon water.</li>
                            <li>Hold off brushing: Avoid brushing teeth for 60 minutes after.</li>
                            <li>Best toothbrush: Use soft toothbrush and avoid aggressive brushing.</li>
                        </ul>
                    </div>
                </div>
                <div className="svg-side">
