...
const LemonSectionBenefits = ({offsetY}) => {
    ...
    return (
        <section className="lemon-selection-benefits" >
            ...
            <div  className="lemon-selection-benefits-picture" ref={lemonSelectionBenefitsPictureRef}>
                <div className="card-lemon1" style={styles} >
                    <h3>Lemon</h3>
                    <p>Lemon is a very complete citrus. The benefits and properties that this citrus contains and that have a direct impact on the human body are many.</p>
                    <p>At Pilmifresh we offer the best quality frozen lemon.  We carry different varieties of  lemon juice;  we also offer frozen lemon slices and wedges.  As well as, lemon peel in strips, zest and dices.</p>
                </div>
